...
app.title = 'Automobile Sales Statistics Dashboard (1980-2023)'
# Create the dropdown menu options
dropdown_options = [
    {'label': 'Yearly Statistics report', 'value': 'Yearly Statistics report'},
...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard (1980-2023)",
...
# use groupby to create relevant data for plotting
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(yearly_rec,
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation over Recession Period (Yearly)"
            )
        )
        R_chart1.figure.update_layout(
            xaxis_title='Year',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_rate,
                ...
                y='Automobile_Sales',
                color='Vehicle_Type',
                title="Effects of Unemployment Rate on Automobile Sales by Type during Recession Period"
            )
        )
        R_chart4.figure.update_layout(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1.figure.update_layout(
            xaxis_title='Year',
            yaxis_title='Sum of Automobile Sales',
            )
...
# Plot bar chart for average number of vehicles sold by vehicle type during the given year
        ...
        Y_chart3.figure.update_layout(
            xaxis_title='Vehicle Type',
            yaxis_title='Average of Automobile Sales',
            )
